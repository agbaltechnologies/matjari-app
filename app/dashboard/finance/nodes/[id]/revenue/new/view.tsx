...
export default function NewFinanceRevenuePage() {
  ...
  const [form, setForm] = useState({ category: '', description: '', amount: '', occurredAt: new Date().toISOString().slice(0, 10) });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await financeApi.createRevenue(orgId, {
        nodeId,
  ...
  return (
    <div className="max-w-md">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">New Revenue Entry</h1>
